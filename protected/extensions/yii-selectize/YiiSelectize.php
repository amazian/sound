...
class YiiSelectize extends CInputWidget
{
    ...
    public function registerScripts() {
        ...
        // JS
        if (YII_DEBUG) {
            $this->_clientScript->registerScriptFile($this->_vendorBaseUrl . '/dist/js/standalone/selectize.js', CClientScript::POS_END);
        } else {
            $this->_clientScript->registerScriptFile($this->_vendorBaseUrl . '/dist/js/standalone/selectize.min.js', CClientScript::POS_END);
        }
    ...
    public function run() {
        ...
        $this->_clientScript->registerScript(__CLASS__ . '_' . $this->id, $initSelectize, CClientScript::POS_READY);
    }
