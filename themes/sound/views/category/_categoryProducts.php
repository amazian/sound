    ...
    <tbody>
        <?php foreach ($category->activeProducts as $product): ?>
            ...
            <tr>
                ...
                <td>
                    <?php if(isset($product->primarySpec)): ?>
                    <?php $primerySpec = $product->primarySpec; ?>
                    <?php echo $primerySpec->value_init; ?><?php echo ($primerySpec->value_end != '') ? ' ~ ' . $primerySpec->value_end : ''; ?><?php echo (!is_null($primerySpec->unit)) ? ' ' . $primerySpec->unit->name : ''; ?>
                    <?php endif; ?>
                </td>
