                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <p class="navbar-text pull-right">
                            <?php if(Yii::app()->user->isGuest): ?><a href="<?php echo $this->createUrl('/site/login'); ?>" class="navbar-link">Login</a><?php else: ?>Welcome, go to your <a href="<?php echo $this->createUrl('/myAccount/index'); ?>" class="navbar-link">account</a> / <a href="<?php echo $this->createUrl('/site/logout'); ?>" class="navbar-link">Logout</a><?php endif; ?> / <a href="<?php echo $this->createUrl('/shoppingCart/index'); ?>" class="navbar-link">My Cart</a> (<?php echo Yii::app()->user->countItemsOnCart(); ?>)<?php if(Yii::app()->user->isGuest): ?> / <a href="<?php echo $this->createUrl('/site/register'); ?>" class="navbar-link">Register</a><?php endif; ?>
                        </p>
                        <ul class="nav">

                            <li><a href="<?php echo $this->createUrl('/site/about'); ?>">公司簡介<br />About</a></li>
