...
<?php foreach ($products as $product): ?>
            <tr>
                ...
                <td><?php echo !is_null($product->primarySpec) ? $product->primarySpec->description->name : ""; ?></td>
                <td><?php echo !is_null($product->category) ? $product->category->getFullname() : null; ?></td>
